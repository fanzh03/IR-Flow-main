...
from data.file_client import FileClient
from data.img_util import imfrombytes, img2tensor, padding, padding_DP, imfrombytesDP
from data.util import scandir
...
#
#         return {"LQ": img_lq, "GT": img_gt, "LQ_path": lqR_path, "GT_path": gt_path}
#
#     def __len__(self):
#         return len(self.paths)
